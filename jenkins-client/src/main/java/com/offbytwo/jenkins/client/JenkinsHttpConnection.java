...
public interface JenkinsHttpConnection extends Closeable {
	...
	/**
     * Perform a GET request and parse the response to the given List of Classes
	 * @param path path to request, can be relative or absolute
	 * @param typeReference TypeReference of List of Classes
	 * @returna List of instances of the supplied class
	 */
	public  <T extends BaseModel> List<T> get(String path, TypeReference<List<T>> typeReference);
